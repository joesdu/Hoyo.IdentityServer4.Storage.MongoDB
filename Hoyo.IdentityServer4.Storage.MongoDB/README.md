#### IdentityServer 4.x Data Persistence for MongoDB

- 由于ids4已经停止维护,所以本库不再主要更新,但是接受PR和issue.业余时间会进行更新.
- 推荐升级 ids6.x + 并使用 [Hoyo.IdentityServer.Storage.MongoDB](https://www.nuget.org/packages/Hoyo.IdentityServer.Storage.MongoDB)
